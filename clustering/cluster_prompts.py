...
print()
data_df.to_csv("results/berttopic/pickled_custom_umap_euclidean_gpt_bigrams_v15_500_with_class.csv")
scores = diversity_score("results/berttopic/pickled_custom_umap_euclidean_gpt_bigrams_v15_500.png")
print()
...
pickle.dump(model, open('results/berttopic/custom_umap_euclidean_gpt_bigrams_v15_50.pkl','wb'))
